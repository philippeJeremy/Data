...
class YelpSpider(scrapy.Spider):
    ...
    def after_search(self, response):
        ...
        try:
            next_page = response.xpath('//*[@id="main-content"]/div/ul/li[14]/div/div[1]/div/div[11]/span/a').attrib["href"]
        except KeyError:
...
if filename in os.listdir('02-Optional_Scraping_Yelp/'):
        os.remove('02-Optional_Scraping_Yelp/' + filename)
...
process = CrawlerProcess(settings = {
    ...
    "FEEDS": {
        '02-Optional_Scraping_Yelp/' + filename: {"format": "json"},
    }
})
